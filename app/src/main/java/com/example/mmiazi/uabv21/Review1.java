 ...
 * {@link Review1.OnFragmentInteractionListener} interface
...
public class Review1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootview =  inflater.inflate(R.layout.fragment_review1, container, false);

        Button shareButton1 = rootview.findViewById(R.id.button_share1);
//        ImageView profilePic = rootview.findViewById(R.id.iv_cad1_photo);
//        RatingBar ratingBar = rootview.findViewById(R.id.ratingBar1);
//        TextView textProdName  = rootview.findViewById(R.id.tv_cad1);
//        CheckBox checkName = rootview.findViewById(R.id.ctv_cad1_name);
